...
public class QuadrupleTest {
    ...
    public void testGet1() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
    ...
    public void testWith1() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
        Quadruple<Character, Integer, Double, Long> quadWith = quad.with1('c');
    ...
    public void testWith2() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
        Quadruple<String, Character, Double, Long> quadWith = quad.with2('c');
    ...
    public void testWith3() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
        Quadruple<String, Integer, Character, Long> quadWith = quad.with3('c');
        assertEquals("foo", quadWith.get1());
        assertEquals(Integer.valueOf(42), quadWith.get2());
    ...
    public void testWith4() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
        Quadruple<String, Integer, Double, Character> quadWith = quad.with4('c');
        assertEquals("foo", quadWith.get1());
        assertEquals(Integer.valueOf(42), quadWith.get2());
        assertEquals(Double.valueOf(Math.PI), quad.get3());
    ...
    public void testMap1() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
        Quadruple<Integer, Integer, Double, Long> quadMap = quad.map1(String::length);
    ...
    public void testMap2() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
        Quadruple<String, String, Double, Long> quadMap = quad.map2(n -> "number " + n);
    ...
    public void testMap3() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 1L);
        Quadruple<String, Integer, Double, Long> quadMap = quad.map3(d -> -d);
        assertEquals("foo", quadMap.get1());
        assertEquals(Integer.valueOf(42), quadMap.get2());
        assertEquals(Double.valueOf(-Math.PI), quadMap.get3());
        assertEquals(Long.valueOf(1L), quad.get4());
    ...
    public void testMap4() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 9L);
        Quadruple<String, Integer, Double, Double> quadMap = quad.map4(n -> Math.sqrt(n));
        assertEquals("foo", quadMap.get1());
        assertEquals(Integer.valueOf(42), quadMap.get2());
        assertEquals(Double.valueOf(Math.PI), quadMap.get3());
    ...
    public void testQuadmap() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, Math.PI, 9L);
        Quadruple<Integer, String, Double, Double> quadMap = quad.quadmap(
    ...
    public void testFold() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foobar", 3, 0.5, 9L);
    ...
    public void testToString() throws Exception {
        Quadruple<String, Integer, Double, Long> quad = Quadruple.of("foo", 42, 0.5, 9L);
        assertEquals("(foo,42,0.5,9)", quad.toString());
    }

    @Test
    public void testHashCode() throws Exception {
        Quadruple<String, Integer, Double, Long> quad1 = Quadruple.of("foo", 4711, Math.PI, 9L);
        Quadruple<String, Integer, Double, Long> quad2 = Quadruple.of("foo", 4711, Math.PI, 9L);
    ...
    public void testEquals() throws Exception {
        Quadruple<String, Integer, Double, Long> quad1 = Quadruple.of("foo", 4711, Math.PI, 9L);
        Quadruple<String, Integer, Double, Long> quad2 = Quadruple.of("foo", 4711, Math.PI, 9L);
        Quadruple<String, Integer, Double, Long> quad3 = Quadruple.of("bar", 4711, Math.PI, 9L);
        Quadruple<String, Integer, Double, Long> quad4 = Quadruple.of("foo", 42, Math.PI, 9L);
        Quadruple<String, Integer, Double, Long> quad5 = Quadruple.of("foo", 4711, Math.E, 9L);
        Quadruple<String, Integer, Double, Long> quad6 = Quadruple.of("foo", 4711, Math.PI, 11L);
